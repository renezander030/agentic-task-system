...
You'll typically pair it with a storage adapter — see [`@reneza/ats-adapter-ticktick`](https://npmjs.com/package/@reneza/ats-adapter-ticktick) for the reference implementation, or write your own adapter against the [6-method interface](https://github.com/renezander030/agentic-task-system/blob/main/docs/adapter-interface.md).
