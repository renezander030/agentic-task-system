...
export function buildTaskGraph(adapter: Adapter, root: { projectId: string; taskId: string }, options?: { depth?: number; maxNodes?: number; cache?: boolean }): Promise<Record<string, unknown>>;
